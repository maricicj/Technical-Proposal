...
\def\voltexecsumm{Volume 1: \textit{Executive Summary\xspace}}
\def\volspfd{EXAMPLE OUTLINE \\ \medskip \textit{An example outline has been provided for the convenience of consortia editors. Please modify according to your needs. \\ \medskip Final version of table of contents is due to Sam and Tim by January 12, 2018.} \\ \vspace{1cm} Volume 2: \textit{The Single-Phase Far Detector\xspace}  }
\def\voldpfd{Volume 3: \textit{The Dual-Phase Far Detector\xspace}}
\def\volswcomputing{Volume 4: \textit{Software and Computing\xspace}}
