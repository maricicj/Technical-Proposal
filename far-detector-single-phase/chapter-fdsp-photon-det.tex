...
\subsubsection{FNAL/MIT bars (4 pages)}
...
\fixme{Different subsections for bars and ARAPUCA?}
...
\subsubsection{FNAL/MIT Modules (2 pages)}
\label{ssec:fdsp-pd-pc-assy-bar1}

\subsubsection{IU Modules (2 pages)}
...
\fixme{\color{blue} Content: Buchanan/Kemp}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Calibration/Monitoring  (2 pages)}
