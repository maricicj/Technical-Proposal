...
The TPMs are produced from a \texttt{trigger primitive production
...
\metainfo{Describe the dataflow {\it infrastructure}. This should cover transport of local trigger information, infrastructure for generating local and global triggers, as well as what happens to the data once a trigger is generated (ie. event building).
