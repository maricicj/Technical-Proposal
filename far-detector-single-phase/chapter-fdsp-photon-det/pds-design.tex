...
\metainfo{\color{blue} Content: A.A.Machado (?)}

\fixme{May not have figures integrated yet (or bibliography) - LMM }
...
\metainfo{\color{blue} Content: (3 pages) - Moreno/Franchi/Djurcic}
