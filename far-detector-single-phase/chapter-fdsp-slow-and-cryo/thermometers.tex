...
\begin{dunefigure}[diag PT102]{fig:fd-slow-cryo-sensor-pt102}
  ...
  \includegraphics[width=0.4\textwidth]{fd-slow-cryo-sensor-pt102.png}
\end{dunefigure}
...
\begin{dunefigure}[dyn-T-grad]{fig:fd-slow-cryo-dt-monitor-overview}
 ...
 \includegraphics[width=0.11\textwidth,angle=90]{fd-slow-cryo-dt-monitor-overview.png}
\end{dunefigure}
\begin{dunefigure}[]{fig:fd-slow-cryo-sensor-mount}
  {Sensor mounted on a PCB board and PCB board mounted on the rod. }
  \includegraphics[width=0.30\textwidth]{fd-slow-cryo-sensor-mount.png}
\end{dunefigure}
\begin{dunefigure}[]{fig:fd-slow-cryo-motor}
  ...
  \includegraphics[width=0.12\textwidth]{fd-slow-cryo-motor.png}
\end{dunefigure}
