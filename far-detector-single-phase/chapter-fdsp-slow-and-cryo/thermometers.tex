...
\begin{dunefigure}[Schematic diagram of the PT102 sensor from the Lakeshore company planned to be used in DUNE.]{fig:cryo-sensor-pt102}
\centering
  \includegraphics[width=0.3\textwidth]{cryo-sensor-pt102.png}
\end{dunefigure}

\subsubsubsection{Dynamic t-gradient monitor design}
...
\begin{dunefigure}
\centering
\begin{minipage}[An overview of the dynamic T-gradient monitor.]{fig:cryo-dt-monitor-overview}{.12\textwidth}
  \centering
 \includegraphics[width=0.95\linewidth]{cryo-dt-monitor-overview.png}
\end{minipage}
\hfill
\begin{minipage}{0.555\textwidth}[Sensor mounted on a PCB board and PCB board mounted on the rod.]{fig:cryo-sensor-mount}
\vspace{2.5in}
  \centering
  \includegraphics[width=0.95\linewidth]{cryo-sensor-mount.png}
\end{minipage}
\hfill
\begin{minipage}{0.27\textwidth}[The driving mechanism of the dynamic T-gradient monitor. It consists of a stepper motor driving the pinion and gear linear motion mechanism.]{fig:cryo-motor}
\vspace{1in}
  \centering
  \includegraphics[width=0.95\linewidth]{cryo-motor.png}
\end{minipage}
\end{figure}
