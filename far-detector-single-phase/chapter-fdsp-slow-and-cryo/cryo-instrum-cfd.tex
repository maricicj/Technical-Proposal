...
Instrumentation inside the cryostat is needed to ensure that the condition of the LAr is adequate for operation of the LAr TPC. This instrumentaion includes purity monitors to  provides high precision electron lifetime measurements, thermometers to monitor the cryogenic system operation, liquid level sensing system during filling and operation and gas analyzers to ensure that the levels of atmospheric contamination drop accordingly to the stage of cryostat purging, cooling, filling and running. A system of internal cameras to help locate sparks in the cryostat is also included.
